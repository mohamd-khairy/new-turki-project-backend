...
if (!function_exists('handleRoleOrderState')) {
    function handleRoleOrderState($roles)
    {
        ...
        if (in_array('store_manager', $roles)) { // 'store_manager' => 'مسئول المبيعات', //////////////
            $data = [
                'status' => ['101', '102', '103', '106', '109', '200', '204', '208', '202', '203', '205', '206', '207', '209' , '301'],
                'orders' => ['100', '101', '102', '103', '104', '105', '106', '109', '200', '204', '208', '202', '203', '205', '206', '207', '209' , '301'],
            ];
        }
        if (in_array('general_manager', $roles)) { // 'general_manager' => 'مشرف المبيعات',/////////////////
            $data = [
                'status' => ['101', '102', '103', '106', '109', '200', '204', '208', '202', '203', '205', '206', '207', '209' , '301'],
                'orders' => ['100', '101', '102', '103', '104', '105', '106', '107', '108', '109', '200', '204', '208', '202', '203', '205', '206', '207', '209' , '301'],
            ];
        }
