...
class FirebaseService
{
    ...
    public function sendNotification($deviceToken, $title, $body, $data = [])
    {
        ...
        //السلات المتروكه خلال وقت معين

        // اعاده الاستهداف
        // اعاده الاستهداف للعملاء القدامي الغير نشطين
        //  السلات المتروكه من وقت كبير جدا
        // العملاء الذين لم يشتروا منذ فتره طويله
        // العملاء الجدد
        // خصم للعملاء القدامي
        // خصم للعملاء الي مطلبوش من سنه او اكثر
        //
        //
